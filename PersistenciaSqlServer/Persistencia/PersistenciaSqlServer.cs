...
namespace PersistenciaSqlServer.Persistencia
{
    public class Persistencia
    {
        ...
        public void establecerConexion(String usuario, String clave)
        {
            ...
            hileraConexion.AppendFormat("{0}", PersistenciaSqlServer.Properties.Settings.Default.DBSodaQuinchoConnectionString);
        ...
        public void establecerConexion2()
        {
            StringBuilder hileraConexion = new StringBuilder();


            hileraConexion.AppendFormat("{0}", PersistenciaSqlServer.Properties.Settings.Default.Conexion);


            hileraConexion.AppendFormat(";User Id={0};Password={1}", "", "");
