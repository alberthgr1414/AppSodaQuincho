...
namespace AppSodaQuincho
{
    public class Neg_General
    {
        ...
        public void ResizeForm(Form ObjForm, int DesignerHeight, int DesignerWidth)
        {
            ...
            ObjForm.Scale(new System.Drawing.SizeF(f_WidthRatio, f_HeightRatio));
            foreach (Control c in ObjForm.Controls)
            {
                ...
                {
                    c.Font = new System.Drawing.Font(c.Font.FontFamily, c.Font.Size * f_HeightRatio, c.Font.Style, c.Font.Unit, ((byte)(0)));
                }
            }
